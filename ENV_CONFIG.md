...
This document explains the environment configuration structure for NUNA VPS/Terminal setup.

## Overview

The NUNA project uses environment variables to manage VPS, MetaTrader, and service configurations. Configuration is organized into three logical files plus a combined option:
...
3. **`.env.secrets.example`** - Services, integrations, and sensitive credentials
...
⚠️ **CRITICAL**: This file contains sensitive credentials. Never commit to version control!
